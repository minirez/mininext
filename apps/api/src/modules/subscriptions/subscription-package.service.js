...
export const list = asyncHandler(async (req, res) => {
  ...
  const packages = await SubscriptionPackage.find(query)
    .populate('services', 'name slug price billingPeriod isActive')
...
export const getById = asyncHandler(async (req, res) => {
  const pkg = await SubscriptionPackage.findById(req.params.id).populate(
    'services',
    'name slug price billingPeriod isActive'
  )
...
export const create = asyncHandler(async (req, res) => {
  ...
  await pkg.populate('services', 'name slug price billingPeriod isActive')
