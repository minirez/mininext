...
const hotelLogo = computed(() => hotelInfo.value?.logo?.url || hotelInfo.value?.images?.[0]?.url)
      ...
      <div :class="['widget-container', { dark: theme === 'dark' }]">
          ...
          <div class="widget-header-left">
            ...
            <div class="widget-hotel-info">
              ...
              <div v-if="hotelStars > 0" class="widget-hotel-stars">
                <svg v-for="i in hotelStars" :key="i" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div v-if="currentStep !== 'confirmation'" class="step-indicator">
          <template v-for="(step, index) in steps.slice(0, -1)" :key="step">
            <div v-if="index > 0" :class="['step-line', { completed: index <= currentStepIndex }]"></div>
            <div :class="['step-item', { active: index === currentStepIndex, completed: index < currentStepIndex }]">
