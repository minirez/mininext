export default {
  ...
  promo: {
    toggle: 'Есть промокод?',
    placeholder: 'Введите промокод',
    apply: 'Применить',
    clear: 'Удалить',
    errors: {
      INVALID_CODE: 'Недействительный промокод',
      EXPIRED_CODE: 'Срок действия промокода истёк',
      NOT_APPLICABLE: 'Промокод не применим к выбранным датам',
      MIN_NIGHTS: 'Минимальный срок проживания для этой акции не достигнут',
      NETWORK_ERROR: 'Ошибка соединения, попробуйте снова',
      PROMO_CODE_REQUIRED: 'Промокод обязателен'
    }
  },
